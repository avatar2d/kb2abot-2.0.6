...
module.exports = {
    ...
    async onMessage(message, reply) {
            ...
            switch(message.body){
                case "1":
                    fca.sendMessage({
                        ...
                        attachment: getFile(`./main/deploy/plugins/citnut/data/12thi/1.png`)
                ...
                case "2":
                    fca.sendMessage({
                        ...
                        attachment: getFile(`./main/deploy/plugins/citnut/data/12thi/2.png`)
                    }, message.threadID, message.messageID);
                break;
                case "3":
                    fca.sendMessage({
                        ...
                        attachment: getFile(`./main/deploy/plugins/citnut/data/12thi/3.png`)
                    }, message.threadID, message.messageID); 
                break;
                case "4":
                    fca.sendMessage({
                        ...
                        attachment: getFile(`./main/deploy/plugins/citnut/data/12thi/4.png`)
                    }, message.threadID, message.messageID); 
                break;
                case "5":
                    fca.sendMessage({
                        ...
                        attachment: getFile(`./main/deploy/plugins/citnut/data/12thi/5.png`)
                    }, message.threadID, message.messageID); 
                break;
                case "6":
                    fca.sendMessage({
                        ...
                        attachment: getFile(`./main/deploy/plugins/citnut/data/12thi/6.png`)
                    }, message.threadID, message.messageID); 
                break;
                case "7":
                    fca.sendMessage({
                        ...
                        attachment: getFile(`./main/deploy/plugins/citnut/data/12thi/7.png`)
                    }, message.threadID, message.messageID); 
                break;
                case "8":
                    fca.sendMessage({
                        ...
                        attachment: getFile(`./main/deploy/plugins/citnut/data/12thi/8.png`)
                    }, message.threadID, message.messageID); 
                break;
                case "9":
                    fca.sendMessage({
                        ...
                        attachment: getFile(`./main/deploy/plugins/citnut/data/13thi/9.png`)
                    }, message.threadID, message.messageID); 
                break;
                case "10":
                    fca.sendMessage({
                        ...
                        attachment: getFile(`./main/deploy/plugins/citnut/data/12thi/10.png`)
                    }, message.threadID, message.messageID); 
                break;
        case "11":
                    fca.sendMessage({
                        ...
                        attachment: getFile(`./main/deploy/plugins/citnut/data/12thi/11.png`)
                    }, message.threadID, message.messageID); 
                break;
        case "12":
                    fca.sendMessage({
                        ...
                        attachment: getFile(`./main/deploy/plugins/citnut/data/12thi/12.png`)
                    }, message.threadID, message.messageID); 
                break;
                default:
        ...
        }else if (message.body.toLowerCase().indexOf("12 thì trong tiếng anh") == 0 || (message.body.toLowerCase().indexOf("12 thì trong tiếng anh") == 0)) {
            fca.sendMessage({
                body: citnut,
                attachment: getFile("./main/deploy/plugins/citnut/data/12thi/12thi.png")
            }, message.threadID, message.messageID);
        }
    },
